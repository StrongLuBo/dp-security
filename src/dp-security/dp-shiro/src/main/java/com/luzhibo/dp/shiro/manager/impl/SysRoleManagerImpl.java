package com.luzhibo.dp.shiro.manager.impl;

import java.util.List;

import com.luzhibo.dp.shiro.dao.SysRoleMapper;
import com.luzhibo.dp.shiro.dao.SysRoleMenuMapper;
import com.luzhibo.dp.shiro.dao.SysUserRoleMapper;
import com.luzhibo.dp.shiro.entity.SysRoleEntity;
import com.luzhibo.dp.shiro.manager.SysRoleManager;
...
public class SysRoleManagerImpl implements SysRoleManager {
	...
	public SysRoleEntity getRoleById(Long id) {
		SysRoleEntity role = sysRoleMapper.findById(id);
